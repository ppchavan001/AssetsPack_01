import { HapticsOnMovementStarted } from "../Haptics/Curves/HapticsOnMovementStarted";
import { EI_JS_Mapping, KeyMapType } from "./EnhancedInputLib";
import IM_DeadZoneAbsolute from "./InputModifiers/IM_DeadZoneAbsolute.u";


class FreePawnInputMappings
{

    public static AddFreePawnInputMappingsToPlayerController(Priority: number = 0, bUseDefaultHandConfiguration: boolean = true): void
    {
        ...
        /** TODO FIX : only one of these are working at one time */

        /** rebuild changes */
        EnhancedInputLibrary.RequestRebuildControlMappingsUsingContext(FreePawnMappingContext, true);
        BFL_EnhancedInputManager.AddNewInputMappingContext(pc, FreePawnMappingContext, Priority);


    }

}
class FreePawnInputMappings_COMPILED extends FreePawnInputMappings { }

export default FreePawnInputMappings;
